...
def symbolic_get_indice_pairs_3d(g, indices, batch_size, out_shape, spatial_shape, ksize, \
        stride, padding, dilation, out_padding, subm, transpose):
    return g.op("GetIndices", indices, batch_size, out_shape, spatial_shape, ksize, \
        stride, padding, dilation, out_padding, subm, transpose)
...
def main():
    ...
    model = build_detector(cfg.nohead_model, train_cfg=None, test_cfg=cfg.test_cfg)
    ...
    for i, data_batch in enumerate(data_loader):
        ...
        register_custom_op_symbolic("spconv::get_indice_pairs_3d", symbolic_get_indice_pairs_3d, 11)
